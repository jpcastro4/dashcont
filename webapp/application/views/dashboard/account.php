        ...
        <div class="container relative my-5 ">
            <div class="row">
                <div class="col-6">
                    <h1 class="contain-title  ">Meus dados</h1>
                </div>
               <!--  <div class="col-6 text-right">
                ...
                <div class="col-12 pt-5">
                    <div class="contain-card p-4">
                        ...
                        <?php //var_dump($this->dashboard->select_rastreadores() ); ?>
                            ...
                            <fieldset class="form-group mb-0">
                                <div class="row">
                                    <div class="form-group col-6 ">
                                        ...
                                        <input type="text" disabled name="clienteNome" class="form-control" required value="<?php echo $cliente->clienteNome ?>" />
                                    </div>
                                    <div class="form-group col-3 ">
                                        <div class="label">CPF</div>
                                        <input type="text" disabled name="clienteCpf" class="form-control" required value="<?php echo $cliente->clienteCpf ?>" />
                                    </div>
                                    <div class="form-group col-3 ">
                                        <div class="label">Data de anivesario</div>
                                        <input type="date" disabled name="clienteAniver" class="form-control" required value="<?php echo $cliente->clienteAniver ?>" />
                                    </div>
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="form-group col-4 ">
                                                ...
                                                <select name="veiculoTipoPgto" class="form-control" >
                                                    <?php foreach($this->dashboard->select_tipo_pagamento()  as $tipo) : ?>
