	      	...
	      	<div class="row py-5">
	        	...
	        	<form action="" method="post" class="row" >
	        		<div class="w-100 text-center my-2">
	        			<h1 class="title-1 ">Esqueceu</h1>
	        		</div>
	          	 		          	 
			        <div class="form-group col-12 has-icon-left form-control-email">
			            <label class="sr-only" for="email">Email</label>
			            <input type="email" name="corretorEmail" class="form-control" id="email" placeholder="E-mail" autocomplete="off" required >
			        </div>

		            <div class="col-12">
	          			<button type="submit" value="submit" name="submit" class="btn btn-theme btn-block">Recuperar</button>
	          		</div>
