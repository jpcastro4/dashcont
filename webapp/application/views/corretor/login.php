...
<!-- 	    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo base_url()?>assets/index/img/favicon/apple-touch-icon-57x57.png">
  	...
  	<body class="bg-black-t" style="background-image: url('<?php echo base_url()?>assets/img/area-do-corretor-santa-tereza-construtora.jpg');background-position: center;background-size: cover;">

 		<div class="pt-5">
		    <div class="contain-card p-4 mx-auto" style="max-width:400px">
		      	...
		      	<div class=" ">
		        	...
		        	<form action="" method="post" class="row" >
		        		<div class="w-100 text-center my-2">
		        			<h1 class="title-1 py-3">Área do corretor</h1>
		        		</div>

				        <div class="form-group col-12 has-icon-left form-control-email">
				            <label class="sr-only" for="email">Email</label>
				            <input type="email" name="corretorEmail" class="form-control" id="email" placeholder="E-mail" autocomplete="off" >
				        </div>

			            <div class="form-group col-12 has-icon-left form-control-password">
			                <label class="sr-only" for="senha">Senha</label>
			                <input type="password" name="corretorSenha" class="form-control" id="senha" placeholder="Senha" autocomplete="off">
			            </div>

			            <div class="col-12">
		          			<button type="submit" value="submit" name="submit" class="btn btn-theme btn-block">Acessar</button>
		          		</div>

			          	<div class="col-12 text-center my-3">
			          		<div class="row">
			          			<div class="col">
			              			<a class=" " href="<?php echo base_url()?>cadastrar"><small>Fazer cadastro</small></a>
			              		</div>
			              		<div class="col">
			              			<a class="" href="<?php echo base_url()?>esqueceu"><small>   Recuperar senha   </small></a>
			              		</div>
			              		<div class="col">
			              			<a class="" href="<?php echo base_url()?>administrativo"><small>Administrativo</small></a>
			              		</div>
			              	</div>
			          	</div>
		          	</form>
